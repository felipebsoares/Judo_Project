...
public class AtletaMapping : IEntityTypeConfiguration<TbAtleta>
{
    public void Configure(EntityTypeBuilder<TbAtleta> builder)
    {
        ...
        builder.ToTable("TB_ATLETAS");
                ...
                builder.HasIndex(e => new { e.IdCliente, e.RegistroConfederacao }, "UK_ATLETAS_REGISTRO_CONFEDERACAO")
                    .IsUnique();

                builder.HasIndex(e => new { e.IdCliente, e.RegistroFederacao }, "UK_ATLETAS_REGISTRO_FEDERACAO")
                    .IsUnique();
